...
namespace Game.Cameras
{
    public class CinemachineCamerasController : MonoBehaviour
    {
        ...
        [Inject] private OverlayPanelsController overlayPanelsController;
        ...
        private void OnEnable()
        {
            ...
            overlayPanelsController.OnPanelOpened += ChangeCursor;
            overlayPanelsController.OnPanelClosed += ChangeCursor;
        }
        ...
        public void DisableCamerasSpeed()
        {
            foreach (var cam in cameras)
            {
                CinemachinePOV pov = cam.Camera.GetCinemachineComponent<CinemachinePOV>();
        ...
        public void EnableCamerasSpeed()
        {
            ChangeCameraSettings();
        }
        ...
        private void ChangeCursor()
        {
            ...
            bool isUIDrawsCursor = UIStateMachine.Context.CurrentState != UIStateMachine.Context.DefaultState || overlayPanelsController.IsPanelOpened;
            Cursor.visible = isCameraDrawsCursor || isUIDrawsCursor;
            Cursor.lockState = Cursor.visible ? CursorLockMode.None : CursorLockMode.Locked;
            if (overlayPanelsController.IsPanelOpened)
                DisableCameraMove();
            else
                EnableCameraMove();
        }
