...
namespace Game.DataBase
{
    ...
    public class ConstructionResourceInfo : ResourceInfo
    {
        ...
        public ConstructionResourceGroup RelatedGroup
        {
            get
            {
                if (!groupInitialized)
                {
                    var g = DB.Instance.ConstructionResourceGroups.Find(x => x.Data.HasInfo(Id));
                    if (g == null)
                    {
        ...
        [System.NonSerialized] private ConstructionResourceGroup relatedGroup = null;
        [System.NonSerialized] private bool groupInitialized = false;
