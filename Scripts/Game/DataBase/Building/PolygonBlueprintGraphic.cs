...
namespace Game.DataBase
{
    ...
    public abstract class PolygonBlueprintGraphic : StaticPoolableObject
    {
        ...
        [SerializeField] private Color neutralPlacementColor = Color.white;
        ...
        [SerializeField] private PlacementType placement = PlacementType.Bad;
        ...
        {
            spriteShapeRenderer.color = placement switch
            {
                PlacementType.Good => goodPlacementColor,
                PlacementType.Neutral => neutralPlacementColor,
                PlacementType.Bad => badPlacementColor,
                _ => throw new System.NotImplementedException($"Placement Type : {placement}")
            };
        }
