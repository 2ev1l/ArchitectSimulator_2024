...
namespace Game.DataBase
{
    public class BlueprintGraphic : StaticPoolableObject
    {
        ...
        /// Use this instead of <see cref="Transform.Rotate"/>
        /// </summary>
        public virtual void RotateBack() => RotateTo(rotationScale + 3);
        /// <summary>
        /// Use this instead of <see cref="Transform.Rotate"/>
        /// </summary>
        ...
        public void GetUICornerParams(out Vector2 widthScale, out Vector2 heightScale, out float rectWidth, out float rectHeight) => GetAnyCornerParams(ChildBase, out widthScale, out heightScale, out rectWidth, out rectHeight);
