...
namespace Game.DataBase
{
    public class BlueprintGraphicUnitState : StateChange
    {
        ...
        internal ConstructionType ApllyableType => applyableType;
        ...
        internal ConstructionSubtype ApplyableSubtype => applyableSubtype;
        ...
        internal ConstructionLocation ApplyableLocation => applyableLocation;
