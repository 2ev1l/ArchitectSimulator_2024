...
namespace Game.DataBase
{
    ...
    public static class RewardTypeExtension
    {
        ...
        public static string GetLanguage(this RewardType type) => type switch
        {
            ...
            RewardType.Hours => LanguageInfo.GetTextByType(TextType.Game, 3),
            RewardType.Mood => LanguageInfo.GetTextByType(TextType.Game, 4),
            RewardType.Rating => LanguageInfo.GetTextByType(TextType.Game, 5),
            _ => throw new System.NotImplementedException($"reward type language {type}"),
        };
        #endregion methods
    }
