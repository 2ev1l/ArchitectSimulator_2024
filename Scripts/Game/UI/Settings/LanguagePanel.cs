...
namespace Game.UI.Settings
{
    public class LanguagePanel : SettingsPanel<LanguageSettings>
    {
        ...
        [SerializeField] private Slider subtitleSpeedSlider;
        ...
        public override LanguageSettings GetNewSettings()
        {
            ...
            float subtitleSpeed = ExposeSlider(subtitleSpeedSlider) / 100f;
            FontStyles fontStyle = (FontStyles)ExposeItemList(fontStyleList);
            LanguageSettings newSettings = new(choosedLanguage, lineSpacing, wordSpacing, characterSpacing, fontStyle, subtitleSpeed);
            return newSettings;
        }
        ...
        public override void UpdateUI()
        {
            ...
            subtitleSpeedSlider.value = Settings.SubtitleSpeed * 100;
