...
namespace Game.UI.Overlay.Computer.DesignApp
{
    ...
    /// </summary>
    public class ConstructionResourceBlueprintItem : ContextActionsItem<ConstructionResourceData>
    {
        ...
        public override void OnListUpdate(ConstructionResourceData param)
        {
            if (Context != param)
            {
